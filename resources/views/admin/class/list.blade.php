    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper"> 
            <div class="content container-fluid">
                <a href=" {{ url('admin/class/create') }}"><button class="btn btn-success" style=" margin-bottom: 3px; margin-left: 85%;">Add New Class</button></a>
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Class List (Total:{{ (($getRecord->total()) )}} )</h5>
                </div>
                <div class="card-body">
                  ...
                  @foreach($getRecord as $value)
                   <tr>
                    ...
                    <td>
                            ...
                            <a href=" {{ url('admin/class/edit') . $value->id}} " class="btn btn-info">Edit</a>
