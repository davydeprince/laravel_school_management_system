  ...
  {{-- Page Main --}}
        <div class="page-wrapper">
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Edit Parent  </h5>
                </div>
                ...
                <input type="text" class="form-control" name="name" value="{{ old('name', $getParent->name) }}" required>
                <div style="color: red">{{ $errors->first('name') }}</div>
                </div>

                <div class="form-group col-md-6">
                    <label>Last Name <span class="login-danger">*</span></label>
                    <input type="text" class="form-control" name="last_name" value="{{ old('last_name', $getParent->last_name) }}" required>
                    <div style="color: red">{{ $errors->first('last_name') }}</div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="mobile_number" value="{{ old('mobile_number', $getParent->mobile_number) }}" required>
                            <div style="color: red">{{ $errors->first('mobile_number') }}</div>
                        </div>

                        <div class="form-group col-md-6">
                            <label>Occuptaion</span> </label>
                            <input type="text" class="form-control" name="occupation" value="{{ old('occupation', $getParent->occupation) }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="blood_group" value="{{ old('blood_group', $getParent->blood_group) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img src=" {{$getParent->getProfile() }}" alt="profile_pic" style="width: 100px">
                            @endif
                        </div>
                ...
                <div class="col-sm-12">
                <input type="email" class="form-control" name="email" value="{{old('email', $getParent->email)}}" id="email" required>
                ...
                <button class="btn btn-danger"><a href="{{ url('admin/admin/list') }}"></a>Back</button>
                </div>
                </form>
                </div>
                </div>
