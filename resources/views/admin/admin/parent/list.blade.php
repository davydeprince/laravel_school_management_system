    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper"> 
            <div class="content container-fluid">
                <a href=" {{ url('admin/admin/parent/add') }}"><button class="btn btn-success" style=" margin-bottom: 3px; margin-left: 85%;">Add New Student</button></a>
               ...
               <div class="form-group col-sm-3">
                 ...
                 <a href="{{ url('admin/admin/parent/list') }}"  class="btn btn-success btn-lg" style="margin-top: 7px">Reset</a>
                </div> 
               </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light" style="font-size: 12px">Parent List (Total: {{ $getParent->total() }})</h5>
                </div>
                <div class="card-body">
                ...
                <tbody>
                   ...
                   <tr>
                    <td>
                        ...
                        <img src="{{ $value->getProfile() }}" style="width: 50px; height: 50px; border-radius: 50px;" alt="profile pic">
                        @endif
                    </td>
                    <td>{{ $value->id}}</td>
                    <td>{{ $value->name}}</td>
                    ...
                    <td>
                    <a href=" {{ url('admin/admin/parent/edit') . $value->id}} " class="btn btn-info">Edit</a>
                        <a href=" {{ url('/admin/admin/parent/delete') . $value->id}} " class="btn btn-danger">Delete</a>
                        <a href=" {{ url('/admin/admin/my_student') . $value->id}} " class="btn btn-warning">My_Student</a>
                        </td>
                   </tr>
                ...
                {!!   $getParent->appends(Illuminate\Support\Facades\Request::except('page'))->links()   !!}
                </div>
                </div>
                </div>
                </div>
