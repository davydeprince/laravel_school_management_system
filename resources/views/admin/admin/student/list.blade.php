    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper"> 
            <div class="content container-fluid">
                <a href=" {{ url('admin/admin/student/add') }}"><button class="btn btn-success" style=" margin-bottom: 3px; margin-left: 85%;">Add New Student</button></a>
            ...
            <div class="row">
                ...
                <h6 class="card-title text-light" style="font-size: 12px">Student List (Total:{{ $getStudent->total() }})</h6>
                </div>
                <div class="card-body">
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td>
                    <a href=" {{ url('admin/admin/student/edit') . $value->id}} " class="btn btn-info">Edit</a>
                        <a href=" {{ url('/admin/admin/student/delete') . $value->id}} " class="btn btn-danger">Delete</a>
                        </td>
                   </tr>
