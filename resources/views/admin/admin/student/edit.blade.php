  ...
  {{-- Page Main --}}
        <div class="page-wrapper">
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Edit Existing Student  </h5>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="admission_number" value="{{ old('admission_number', $getRecord->admission_number) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <option value="">Select Class</option>
                            ...
                            <option {{  (old('class_id', $getRecord->class_id) == $value->id) ? 'selected' : '' }} value="{{ $value->id }}">{{ $value->name }}
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" name="admission_date" value="{{ old('admission_number',$getRecord->admission_date) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img src=" {{$getRecord->getProfile() }}" alt="profile_pic" style="width: 100px">
                            @endif
                        </div>
                ...
                <div class="col-sm-12">
                <input type="email" class="form-control" name="email" value="{{old('email', $getRecord->email)}}" id="email" >
