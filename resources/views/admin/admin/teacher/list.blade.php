    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper"> 
            <div class="content container-fluid">
                <a href=" {{ url('admin/admin/teacher/add') }}"><button class="btn btn-success" style=" margin-bottom: 3px; margin-left: 85%;">Add New Teacher</button></a>
               ...
               <div class="form-group col-sm-3">
                 ...
                 <a href="{{ url('admin/admin/teacher/list') }}"  class="btn btn-success btn-lg" style="margin-top: 7px">Reset</a>
                </div> 
               </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <h6 class="card-title text-light" style="font-size: 12px">Teacher's List ({{ $getTeacher->total()  }})</h6>
                </div>
                <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <img src="{{ $value->getProfile() }}" alt="profile pic" style="height: 50px; width: 50px; border-radius: 50px;">
                      @endif
                    </td>
                    <td>{{ $value->name }}</td>
                    <td>{{ $value->last_name }}</td>
                    <td>{{ $value->email }}</td>
                    <td>{{ date('d-m-Y-H:i A', strtotime($value->date_of_joining)) }}</td>
                  ...
                  <td>
                    <a href="{{ url('admin/admin/teacher/edit'.$value->id) }}" class="btn btn-sm btn-info">Edit</a>
                    <a href="{{ url('admin/admin/teacher/delete'.$value->id) }}" class="btn btn-sm btn-danger">Delete</a>
                  </td>
                  </tr>
