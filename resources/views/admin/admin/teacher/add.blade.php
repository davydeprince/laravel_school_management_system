    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Add New Teacher  </h5>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div style="color: red">{{ $errors->first('last_name') }}</div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" name="date_of_joining" placeholder="Date of Joining">
                ...
                <div class="col-sm-12">
                <input type="email" class="form-control" name="email" value="{{old('name')}}" id="email" required>
