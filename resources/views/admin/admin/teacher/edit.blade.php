  ...
  {{-- Page Main --}}
        <div class="page-wrapper">
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Edit Existing Teacher  </h5>
                </div>
                ...
                <input type="text" class="form-control" name="name" value="{{ old('name', $getTeacher->name) }}">
                </div>

                <div class="form-group col-md-6">
                    <label>Last Name <span class="login-danger">*</span></label>
                    <input type="text" class="form-control" name="last_name" value="{{ old('last_name', $getTeacher->last_name) }}">
                    </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" name="date_of_birth" value="{{ old('date_of_birth',$getTeacher->date_of_birth) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="mobile_number" value="{{ old('mobile_number', $getTeacher->mobile_number )}}">
                        </div>

                        <div class="form-group col-md-6">
                            <label>Admission Date</label>
                            <input type="date" class="form-control" name="admission_date" value="{{ old('admission_number',$getTeacher->admission_date) }}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <label>Profie Pic <span class="login-danger">*</span></label>
                            <input type="file" class="form-control" name="profile_pic" value="{{ old('profile_pic', $getTeacher->profile_pic) }}">
                            @if(!empty($getTeacher->getProfile()))
                            <img src=" {{$getTeacher->getProfile() }}" alt="profile_pic" style="width: 50px">
                            @endif
                        </div>
                ...
                <div class="col-sm-12">
                <input type="email" class="form-control" name="email" value="{{old('email', $getTeacher->email)}}" id="email" >
                ...
                <button class="btn btn-danger"><a href="{{ url('admin/admin/teacher/list') }}"></a>Back</button>
                </div>
                </form>
                </div>
                </div>
