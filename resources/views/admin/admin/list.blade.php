    ...
    <div class="main-wrapper">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                     ...
                     @if(Auth::user()->user_type ==1)
                        ...
                        <li class="submenu">
                            <a href="/admin/admin/student/list"><i class="fas fa-user"></i> <span>Student</span> <span
                                    class="menu-arrow"></span></a>
                        </li>

                    </li>
                    <li class="submenu">
                        <a href="/admin/admin/teacher/list"><i class="fas fa-user"></i> <span>Teacher</span> <span
                                class="menu-arrow"></span></a>
                    </li>

                    </li>
                    <li class="submenu">
                        <a href="/admin/admin/parent/list"><i class="fas fa-user"></i> <span>Parent</span> <span
                                class="menu-arrow"></span></a>
                    </li>
        ...
        <div class="page-wrapper"> 
            <div class="content container-fluid">
                <a href=" {{ url('admin/admin/create') }}"><button class="btn btn-success" style=" margin-bottom: 3px; margin-left: 85%;">Add New admin</button></a>
               ...
               <div class="form-group col-sm-3">
                 ...
                 <a href="{{ url('admin/admin/student/list') }}"  class="btn btn-success btn-lg" style="margin-top: 7px">Reset</a>
                </div> 
               </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Admin List (Total: {{$getRecord->total()}} )</h5>
                </div>
                <div class="card-body">
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td>
                    <a href=" {{ url('admin/admin/edit') . $value->id}} " class="btn btn-info">Edit</a>
