    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper"> 
            <div class="content container-fluid">
                <a href=" {{ url('/admin/course/create') }}"><button class="btn btn-success" style=" margin-bottom: 3px; margin-left: 85%;">Add New Course</button></a>
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Course List (Total:{{ $getRecord->total() }})</h5>
                </div>
                <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href=" {{url('/admin/course/edit') .$value->id }}" class="btn btn-info">Edit</a>
