...
<head>
    ...
    <title>Edit New Assign_Class</title>
  ...
  {{-- Page Main --}}
        <div class="page-wrapper">
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Edit & Assign_Class</h5>
                </div>
                <div class="card-body">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <div>
                            <label>
                            <input type="checkbox" value="{{ old('course_name', $course->id) }}" name="course_id[]"> {{ $course->name }}
                        </label>
                    </div>
                        @endforeach
