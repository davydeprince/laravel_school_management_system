...
<head>
    ...
    <title>Add Assign Subject List</title>
  ...
  {{-- Page Main --}}
        <div class="page-wrapper">
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Add New Assign Class</h5>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div>
                        <label>
                        <input type="checkbox" value="{{ $course->id }}" name="course_id[]"> {{ $course->name }}
                    </label>
                </div>
                    @endforeach
                ...
                <button class="btn btn-danger"><a href="{{ url('admin/class/list') }}"></a>Back</button>
                </div>
                </form>
                </div>
                </div>
