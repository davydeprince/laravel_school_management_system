                ...
                <div id="sidebar-menu" class="sidebar-menu">
                     ...
                     @if(Auth::user()->user_type ==1)
                        ...
                        <li class="submenu active">
                            <a href="/admin/dashboard"><i class="feather-grid @if(Request::segment(2) == 'dashboard') active @endif"></i> <span> Dashboard</span> <span
                                    class="menu-arrow"></span></a>
                        </li>
                        <li class="submenu">
                            <a href="/admin/admin/list"><i class="fas fa-user @if(Request::segment(2) == 'admin') active @endif"></i> <span>Admin</span> <span
                                    class="menu-arrow"></span></a>
                        </li>

                    </li>
                    <li class="submenu">
                        <a href="/logout"><i class="fas fa-user @if(Request::segment(2) == 'logout') active @endif"></i> <span>Logout</span> <span
                                class="menu-arrow"></span></a>
                    </li>
                    </ul>
                     ...
                     @elseif(Auth::user()->user_type == 3) 
                        <ul>
                          ...
                          <li class="submenu active">
                              <a href="/student/dashboard"><i class="feather-grid @if(Request::segment(2) == 'dashboard') active @endif"></i> <span> Dashboard</span> <span
                                      class="menu-arrow"></span></a>
                          </li>

                          <li class="submenu active">
                            <a href="/student/account"><i class="feather-grid @if(Request::segment(2) == 'account') active @endif"></i> <span>My Account</span> <span
                                    class="menu-arrow"></span></a>
                        </li>

                        <li class="submenu active">
                            <a href="/student/myunits"><i class="feather-grid @if(Request::segment(2) == 'account') active @endif"></i> <span>My Units</span> <span
                                    class="menu-arrow"></span></a>
                        </li>
