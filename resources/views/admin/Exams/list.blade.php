...
<head>
    ...
    <title>Assign Subject List</title>
    ...
    <style>
        .alert-success {
            color: #fff;
            font-weight: bold;
            background: rgb(9, 205, 130);
        }

        .alert-error {
            color: #fff;
            font-weight: bold;
            background: rgb(255, 100, 83), 3, 2);
        }
    </style>
</head>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper"> 
            <div class="content container-fluid">
                <a href=" {{ url('admin/assign_subject/create') }}"><button class="btn btn-success" style=" margin-bottom: 3px; margin-left: 85%;">Assign New Subject</button></a>
             
                <form action="#" method="get">
                    <div class="card">
                        <div class="card-header">
                            <h4>Search Assign subject</h4>
                        </div>
                        <div class="card-body">
               <div class="row">
               ...
               <div class="form-group col-sm-3">
                 ...
                 <a href="{{ url('admin/admin/list') }}"  class="btn btn-success btn-lg" style="margin-top: 7px">Reset</a>
                </div> 
               </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <h5 class="card-title text-light">Assign Subject List  |Total: {{ $getRecord->total() }} | </h5>
                </div>
                <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <td>
                             ...
                             <a href=" {{ url('admin/assign_subject/edit') . $value->id}} " class="btn btn-info">Edit</a>
            ...
            <footer>
                <p>Copyright © 2022 {{config('app.name')}}.</p>
            </footer>
        </div>
    </div>
