                    ...
                    <li class="submenu">
                     ...
                     @elseif(Auth::user()->user_type == 2) 
                      <ul>
                        ...
                        <li class="submenu active">
                            <a href="/teacher/dashboard"><i class="feather-grid"></i> <span> Dashboard</span> <span
                                    class="menu-arrow"></span></a>
                        </li>
                        ...
                        <li class="submenu active">
                            <a href="/teacher/account"><i class="nav-link" @if(Request::segment(2)== 'account') active @endif></i> <span>My Account</span> <span
                                    class="menu-arrow"></span></a>
                        </li>
